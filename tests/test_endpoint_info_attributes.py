...
from yakk.provider_discovery import EndpointInfo, ProviderRegistry
...
class TestProviderToolsUsage:
    ...
    async def test_providers_tool_accesses_healthy_field(self):
        ...
        from yakk.tools.providers import refresh_provider_registry
        ...
        with patch('yakk.tools.providers.provider_registry', mock_registry):
    ...
    async def test_devices_tool_accesses_healthy_field(self):
        ...
        with patch('yakk.provider_discovery.provider_registry', mock_registry):
            # Import here to apply the patch
            from yakk.tools.devices import voice_status
...
class TestConverseIntegrationWithEndpointInfo:
    ...
    async def test_converse_handles_missing_endpoint_gracefully(self):
        ...
        with patch('yakk.simple_failover.simple_tts_failover') as mock_tts:
