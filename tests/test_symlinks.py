"""Unit tests for symlink utilities in yakk.utils.symlinks."""
...
def patch_audio_dir(isolate_home_directory, monkeypatch):
    ...
    monkeypatch.setattr("yakk.config.AUDIO_DIR", correct_audio_dir)
    monkeypatch.setattr("yakk.utils.symlinks.AUDIO_DIR", correct_audio_dir)
...
class TestUpdateLatestSymlinks:
    ...
    def test_creates_stt_and_latest_symlinks_for_wav(self, isolate_home_directory):
        ...
        from yakk.utils.symlinks import update_latest_symlinks
        from yakk.config import AUDIO_DIR
...
class TestSymlinkCleanup:
    ...
    def test_removes_only_symlinks_not_regular_files(self, isolate_home_directory, tmp_path):
        ...
        from yakk.utils.symlinks import _remove_old_symlinks
