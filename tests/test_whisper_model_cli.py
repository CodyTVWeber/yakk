...
class TestWhisperModelsCLI:
    ...
    def test_whisper_models_command(self):
        ...
        result = runner.invoke(yakk_main_cli, ['whisper', 'model', '--all'])
...
class TestWhisperModelActiveCLI:
    ...
    def test_show_active_model(self):
        ...
        result = runner.invoke(yakk_main_cli, ['whisper', 'model'])
    ...
    def test_set_active_model(self):
        ...
        with patch('yakk.tools.whisper.models.is_whisper_model_installed') as mock_installed:
            mock_installed.return_value = True

            result = runner.invoke(yakk_main_cli, ['whisper', 'model', 'small', '--no-install'])
...
class TestWhisperModelInstallCLI:
    ...
    def test_install_default_model(self):
        ...
        with patch('asyncio.run') as mock_run:
            ...
            result = runner.invoke(yakk_main_cli, ['whisper', 'model', 'install'])
    ...
    def test_install_specific_model(self):
        ...
        with patch('asyncio.run') as mock_run:
            ...
            result = runner.invoke(yakk_main_cli, ['whisper', 'model', 'install', 'small'])
    ...
    def test_install_invalid_model(self):
        ...
        with patch('asyncio.run') as mock_run:
            ...
            result = runner.invoke(yakk_main_cli, ['whisper', 'model', 'install', 'invalid-model'])
