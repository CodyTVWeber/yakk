...
from yakk.tools.configuration_management import (
    update_config,
    list_config_keys,
    write_env_file,
    parse_env_file,
...
class TestConfigurationManagement:
    ...
    async def test_update_config_returns_message(self):
        ...
        try:
            ...
            with patch("yakk.tools.configuration_management.USER_CONFIG_PATH", Path(temp_path)):
    ...
    async def test_update_config_function_exists(self):
        ...
        with patch("yakk.tools.configuration_management.USER_CONFIG_PATH", Path("/nonexistent/test.env")):
    ...
    async def test_config_functions_integration(self):
        ...
        with patch("yakk.tools.configuration_management.USER_CONFIG_PATH", Path("/tmp/test_config.env")):
...
class TestMultilineValueHandling:
    ...
    def test_update_config_preserves_multiline_values(self):
        ...
        try:
            ...
            with patch("yakk.tools.configuration_management.USER_CONFIG_PATH", temp_file):
