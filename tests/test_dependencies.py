...
from yakk.utils.dependencies.cache import DependencyCache
from yakk.utils.dependencies.checker import detect_platform, check_dependency
from yakk.utils.dependencies.package_managers import (
    BrewManager,
    AptManager,
    DnfManager,
    get_package_manager
...
class TestPackageManagerSelection:
    ...
    @patch('yakk.utils.dependencies.package_managers.BrewManager.check_available')
    ...
    @patch('yakk.utils.dependencies.package_managers.BrewManager.check_available')
    @patch('yakk.utils.dependencies.package_managers.DnfManager.check_available')
    ...
    @patch('yakk.utils.dependencies.package_managers.BrewManager.check_available')
    @patch('yakk.utils.dependencies.package_managers.DnfManager.check_available')
    @patch('yakk.utils.dependencies.package_managers.AptManager.check_available')
