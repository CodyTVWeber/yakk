...
from yakk.core import play_system_audio
from yakk.tools.converse import should_wait, should_repeat, WAIT_PHRASES, REPEAT_PHRASES
...
class TestPlaySystemAudio:
    ...
    async def test_play_system_audio_with_existing_file(self):
        ...
        with patch('yakk.core.Path') as mock_path, \
             patch('yakk.core.AudioSegment') as mock_audio_segment, \
             patch('yakk.core.NonBlockingAudioPlayer') as mock_player:
    ...
    async def test_play_system_audio_fallback_to_tts(self):
        ...
        with patch('yakk.simple_failover.simple_tts_failover', new_callable=AsyncMock) as mock_tts:
    ...
    async def test_play_system_audio_file_playback_error_fallback(self):
        ...
        with patch('yakk.core.NonBlockingAudioPlayer') as mock_player, \
             patch('yakk.simple_failover.simple_tts_failover', new_callable=AsyncMock) as mock_tts:
