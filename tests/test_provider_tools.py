...
from yakk.provider_discovery import ProviderRegistry, EndpointInfo
...
class TestProviderToolsIntegration:
    ...
    async def test_refresh_creates_valid_endpoints(self):
        ...
        from yakk.tools.providers import provider_registry
        ...
        with patch('yakk.tools.providers.TTS_BASE_URLS', test_tts_urls), \
             patch('yakk.tools.providers.STT_BASE_URLS', test_stt_urls):
