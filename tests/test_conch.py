...
class TestConchConfig:
    ...
    def test_conch_enabled_default(self):
        ...
        from yakk.config import CONCH_ENABLED
    ...
    def test_conch_timeout_default(self):
        ...
        from yakk.config import CONCH_TIMEOUT
    ...
    def test_conch_check_interval_default(self):
        ...
        from yakk.config import CONCH_CHECK_INTERVAL
    ...
    def test_conch_enabled_env_var(self):
        ...
        assert yakk.config.CONCH_ENABLED is False

        # Test with true
        os.environ["YAKK_CONCH_ENABLED"] = "true"
        importlib.reload(yakk.config)
        assert yakk.config.CONCH_ENABLED is True
    ...
    def test_conch_timeout_env_var(self):
        ...
        importlib.reload(yakk.config)
        assert yakk.config.CONCH_TIMEOUT == 120.0
