...
class TestAudioFormatConfiguration:
    ...
    def test_default_audio_format(self):
        ...
        from yakk.config import AUDIO_FORMAT, TTS_AUDIO_FORMAT, STT_AUDIO_FORMAT
    ...
    def test_validate_audio_format(self):
        ...
        from yakk.config import validate_audio_format
    ...
    def test_get_provider_supported_formats(self):
        ...
        from yakk.config import get_provider_supported_formats
    ...
    def test_get_audio_loader_for_format(self):
        ...
        from yakk.config import get_audio_loader_for_format
    ...
    def test_get_format_export_params(self):
        ...
        from yakk.config import get_format_export_params, MP3_BITRATE, OPUS_BITRATE
    ...
    def test_invalid_format_fallback(self):
        ...
        from yakk.config import AUDIO_FORMAT
    ...
    def test_format_specific_bitrate_settings(self):
        ...
        from yakk.config import OPUS_BITRATE, MP3_BITRATE, AAC_BITRATE
    ...
    def test_custom_bitrate_settings(self):
        ...
        from yakk.config import OPUS_BITRATE, MP3_BITRATE
