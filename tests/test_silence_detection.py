"""Tests for silence detection feature in yakk."""
...
# Mock webrtcvad before importing yakk modules
sys.modules['webrtcvad'] = MagicMock()

from yakk.tools.converse import (
...
class TestSilenceDetection:
    ...
    def mock_sounddevice(self):
        ...
        with patch('yakk.tools.converse.sd') as mock_sd:
    ...
    def mock_vad(self):
        ...
        with patch('yakk.tools.converse.webrtcvad') as mock_webrtcvad:
    ...
    @patch('yakk.tools.converse.DISABLE_SILENCE_DETECTION', False)
    @patch('yakk.tools.converse.VAD_AVAILABLE', True)
    ...
    @patch('yakk.tools.converse.DISABLE_SILENCE_DETECTION', True)
    @patch('yakk.tools.converse.VAD_AVAILABLE', True)
    def test_silence_detection_disabled(self, mock_vad, mock_sounddevice):
        """Test that silence detection can be disabled."""
        with patch('yakk.tools.converse.record_audio') as mock_record:
    ...
    @patch('yakk.tools.converse.DISABLE_SILENCE_DETECTION', False)
    @patch('yakk.tools.converse.VAD_AVAILABLE', False)
