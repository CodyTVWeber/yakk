...
class TestServeTransportOption:
    ...
    def test_serve_help_shows_transport_option(self):
        ...
        runner = CliRunner()
        result = runner.invoke(yakk_main_cli, ['serve', '--help'])
    ...
    def test_default_transport_is_streamable_http(self):
        ...
        try:
            ...
            assert yakk.config.SERVE_TRANSPORT == "streamable-http"
        finally:
            # Restore env var
    ...
    def test_env_var_changes_default(self):
        ...
        try:
            ...
            assert yakk.config.SERVE_TRANSPORT == "sse"
        finally:
            # Restore env var
            if env_backup is not None:
                os.environ["YAKK_SERVE_TRANSPORT"] = env_backup
    ...
    def test_transport_option_streamable_http(self):
        ...
        # Patch at the import location in yakk.cli
        with patch.dict('sys.modules', {'yakk.server': MagicMock(mcp=mock_mcp)}):
