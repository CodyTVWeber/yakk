...
The `get_all_available_tools()` function in `yakk/tools/__init__.py` discovers tools by:
...
1. Create `yakk/tools/{tool_name}.py`
...
1. Create directory: `yakk/tools/services/{service}/`
...
- `yakk/tools/__init__.py` - Discovery and loading logic
- `yakk/server.py` - MCP server initialization
